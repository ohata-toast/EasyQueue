...
EasyQueue 토픽은 관련된 주제에 대한 메시지의 그룹화 단위입니다. 애플리케이션 간 데이터를 비동기적으로 발행 및 구독하기 위해 사용됩니다.
...
### 모니터링
* EasyQueue 토픽 모니터링을 통해 토픽의 유입/유출 Byte Rate, 메시지 수, 컨슈머 그룹별 Lag, 전체 데이터 사이즈 지표를 확인할 수 있습니다.
